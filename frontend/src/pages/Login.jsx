...
// // later after in real email verication i need to remove the total down code and i need to uncomment the above code then real emailauthentication will work until then it will be in devemoper mode
...
//       // 🔥 TEMP DEV BYPASS (force marked as verified)
...
//         {error && (
//           <div className="bg-red-100 border border-red-400 text-red-700 px-3 py-2 rounded-lg relative mb-4">
//             <span>{error}</span>
//           </div>
//         )}
